...
def is_bot_running(process_name):
    ...
    for process in psutil.process_iter(attrs=['pid', 'name', 'cmdline']):
        try:
            ...
            if process.info['cmdline'] and 'bot.py' in process.info['cmdline']:
                return True
...
def restart_bot():
    # Replace 'python3 bot.py' with the actual command to start your bot
    os.system("python3 bot.py &")  # Start your bot in the background

if __name__ == "__main__":
    bot_process_name = "bot.py"  # The name of your bot's script
    while True:
